...
module.exports = {
  ...
  logo: '/img/book.png', // 导航栏logo
  repo: 'Somnus711/Somnus711.github.io', // 导航栏右侧生成Github链接
  docsBranch: 'main',
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:haoyuan1996@qq.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/Somnus711',
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
  ...
  footer: {
    ...
    copyrightInfo:
      `Somnus Haoyuan | <a href="https://github.com/Somnus711/Somnus711.github.io/blob/main/LICENSE" target="_blank">MIT
            License</a><br />
