...
- name: Young Kbt Blog	# 昵称
  ...
  avatar: https://cdn.jsdelivr.net/gh/Somnus711/picx-images-hosting@master/avatar/avatar.1ap66ci2m4.webp	# 头像
...
与我 [联系](mailto:haoyuan1996@qq.com) 或者 在本页面评论区留言您的友链信息，格式：(点击代码块右上角一键复制)

```yml
- name: Haoyuan's Blog	# 昵称
  desc: 学习是一件快乐的事情。	# 介绍
  avatar: https://cdn.jsdelivr.net/gh/Somnus711/picx-image-hosting@master/blog-pic/avatar.2b7e13idyy9s.webp	# 头像
